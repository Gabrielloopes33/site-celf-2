...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={`relative z-10 flex max-w-max flex-5 items-center justify-center ${className}`}
    {...props}
  >
    {children}
...
>(({ className, ...props }, ref) => (
  <div className="absolute left-0 top-full flex justify-center">
    <NavigationMenuPrimitive.Viewport
      className={`origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border bg-background text-foreground shadow md:w-[var(--radix-navigation-menu-viewport-width)] ${className}`}
      ref={ref}
      {...props}
    />
  </div>
