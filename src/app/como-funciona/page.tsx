...
import { ClipboardCheck, Cog, FileSearch, HeartHandshake, MessageSquare, Users } from "lucide-react";
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <div className="relative">
              {/* Timeline line */}
              <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-blue-900/40"></div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="z-10 flex items-center justify-center w-10 h-10 bg-primary rounded-full md:mx-auto">
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 hidden md:block"></div>
                <div className="z-10 flex items-center justify-center w-10 h-10 bg-secondary rounded-full md:mx-auto">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <Tabs.Root defaultValue="tab1" className="w-full">
            <Tabs.List className="flex flex-wrap border-b border-blue-900/40 mb-8">
              <Tabs.Trigger value="tab1" className="px-5 py-3 font-medium text-gray-600 hover:text-primary data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:text-primary">
                Gerente de Operações
              </Tabs.Trigger>
              <Tabs.Trigger value="tab2" className="px-5 py-3 font-medium text-gray-600 hover:text-primary data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:text-primary">
                Supervisor Técnico
              </Tabs.Trigger>
              <Tabs.Trigger value="tab3" className="px-5 py-3 font-medium text-gray-600 hover:text-primary data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:text-primary">
                Equipe Técnica
              </Tabs.Trigger>
              <Tabs.Trigger value="tab4" className="px-5 py-3 font-medium text-gray-600 hover:text-primary data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:text-primary">
                Suporte ao Cliente
              </Tabs.Trigger>
            </Tabs.List>

            <Tabs.Content value="tab1" className="p-6 bg-white/10 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-4">Gerente de Operações</h3>
            ...
            <Tabs.Content value="tab2" className="p-6 bg-white/10 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-4">Supervisor Técnico</h3>
              <p className="text-gray-600 mb-4">
            ...
            <Tabs.Content value="tab3" className="p-6 bg-white/10 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-4">Equipe Técnica</h3>
              <p className="text-gray-600 mb-4">
            ...
            <Tabs.Content value="tab4" className="p-6 bg-white/10 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-4">Suporte ao Cliente</h3>
              <p className="text-gray-600 mb-4">
